        ...
        className='w-full h-screen bg-cover bg-center py-10 sm:px-20 px-5 text-white '>
            <div className='flex flex-row justify-between'>
                ...
                <div className='flex flex-row gap-5'>
                    <button
                    className='sm:px-5 sm:py-3 bg-black text-white rounded-lg hover:buttonShadow font-semibold px-3 py-2 cursor-pointer sm:text-lg text-sm'
            ...
            <div className='mt-10 px-5 flex flex-col items-center justify-center'>
                ...
                className='mt-10 w-auto px-10 text-white rounded-lg bg-black cursor-pointer py-3 hover:buttonShadow'>
                    Upload
                </button>
            </div>
        </div>
